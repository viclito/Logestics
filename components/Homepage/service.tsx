        ...
        <div className='max-w-[1400px] px-6 mx-auto'>
            ...
            <div className='flex w-[100%] xl:flex-col pt-10 items-center md:gap-12'>
                ...
                <div className='w-[60%] md:w-[100%] flex relative h-[500px] md:h-[300px] items-center justify-center' ref={ref}>
                    <div className='flex md:w-[360px] relative m-auto md:h-[calc(200px+30px)] w-[600px] h-[350px]'>

                        <motion.div style={{scaleY:scaleProgress, opacity:scaleProgress}} initial={{y:50}} whileInView={{y:0}} transition={{duration:.5}} className={` bg-white absolute overflow-hidden flex items-center justify-center transition-all duration-100 ${styles.image} ${one? 'h-[400px] w-[670px] z-40 md:h-[290px] md:w-[360px] rounded-lg left-0 top-0': 'h-[300px] w-[180px] md:h-[200px] md:w-[120px] rounded-full'}`} onClick={oneFunc}>
                            <Image src={ocean} alt='' className={`  ${styles.one} ${one?'h-[400px] w-[670px] z-40 md:h-[290px] md:w-[360px] rounded-lg':'h-[290px] w-[170px] md:h-[190px] md:w-[110px] rounded-full'}`}/>
                            <h1 className={`absolute top-10 z-20 font-bold text-white p-1 rounded-md text-sm text-center `}>Ocean <br /> Frieght</h1>
                        </motion.div>
                        <motion.div style={{scaleY:scaleProgress, opacity:scaleProgress}} initial={{y:50}} whileInView={{y:0}} transition={{duration:.5}} className={` bg-white absolute overflow-hidden   flex items-center justify-center transition-all duration-100 ${styles.image} ${two? 'h-[400px] w-[670px] z-40 md:h-[290px] md:w-[360px] rounded-lg left-0 top-0': 'h-[300px] w-[180px] md:h-[200px] md:w-[120px] left-[120px] md:left-[60px] top-24 rounded-full'}`} onClick={twoFunc}>
                            <Image src={air} alt='' className={` ${styles.two} ${two?'h-[400px] w-[670px] z-40 md:h-[290px] md:w-[360px] rounded-lg':'h-[290px] w-[170px] md:h-[190px] md:w-[110px] rounded-full'}`}/>
                            <h1 className={`absolute bottom-10 z-20 font-bold text-white p-1 rounded-md text-sm text-center`}>Air <br /> Frieght</h1>
                        </motion.div>
                        <motion.div style={{scaleY:scaleProgress, opacity:scaleProgress}} initial={{y:50}} whileInView={{y:0}} transition={{duration:.5}} className={` bg-white absolute overflow-hidden flex items-center justify-center transition-all duration-100 ${styles.image} ${three? 'h-[400px] w-[670px] z-40 md:h-[290px] md:w-[360px] rounded-lg left-0 top-0': 'h-[300px] w-[180px] md:h-[200px] md:w-[120px] rounded-full left-[calc(120px+120px)] md:left-[calc(60px+60px)] '}`} onClick={threeFunc}>
                            <Image src={breakbulk} alt='' className={` ${styles.three} ${three?'h-[400px] w-[670px] z-40 md:h-[290px] md:w-[360px] rounded-lg':'h-[290px] w-[170px] md:h-[190px] md:w-[110px] rounded-full'}`}/>
                            <h1 className={`absolute top-10 z-20 font-bold text-white p-1 rounded-md text-sm text-center`}>Break <br /> bulk</h1>
                        </motion.div>
                        <motion.div style={{scaleY:scaleProgress, opacity:scaleProgress}} initial={{y:50}} whileInView={{y:0}} transition={{duration:.5}} className={` bg-white absolute overflow-hidden flex items-center justify-center transition-all duration-100 ${styles.image} ${four? 'h-[400px] w-[670px] z-40 md:h-[290px] md:w-[360px] rounded-lg left-0 top-0': 'h-[300px] w-[180px] md:h-[200px] md:w-[120px] rounded-full left-[calc(120px+120px+120px)] md:left-[calc(60px+60px+60px)] top-24'}`} onClick={fourFunc}>
                            <Image src={warhouse} alt='' className={` ${styles.four} ${four?'h-[400px] w-[670px] z-40 md:h-[290px] md:w-[360px] rounded-lg':'h-[290px] w-[170px] md:h-[190px] md:w-[110px] rounded-full'}`}/>
                            <h1 className={`absolute bottom-10 z-20 font-bold text-white p-1 rounded-md text-sm text-center`}>Ware <br /> House</h1>
                        </motion.div>
                        <motion.div style={{scaleY:scaleProgress, opacity:scaleProgress}} initial={{y:50}} whileInView={{y:0}} transition={{duration:.5}} className={` bg-white absolute overflow-hidden  flex items-center justify-center transition-all duration-100 ${styles.image} ${five? 'h-[400px] w-[670px] z-40 md:h-[290px] md:w-[360px] rounded-lg left-0 top-0': 'h-[300px] w-[180px] md:h-[200px] md:w-[120px] rounded-full left-[calc(120px+120px+120px+120px)] md:left-[calc(60px+60px+60px+60px)]'}`} onClick={fiveFunc}>
                            <Image src={multi} alt='' className={` ${styles.five} ${five?'h-[400px] w-[670px] z-40 md:h-[290px] md:w-[360px] rounded-lg':'h-[290px] w-[170px] md:h-[190px] md:w-[110px] rounded-full'}`}/>
