  ...
  return (
    <div className="relative">
      ...
      <Image
        src={Ellipse2}
        alt=""
        className="absolute left-[1%] -top-[30%] w-[1000px] h-auto z-0 rotate-180 blur-2xl"
      />
      <div className="max-w-[1200px] mx-auto py-12 md:py-2 relative z-10">
        <h2 className="font-bold text-4xl lg:text-3xl md:text-2xl  text-start md:text-center py-6 pb-10">
          With J Logistics , <span className="text-primary">U can</span>{" "}
        </h2>
        ...
        <div className="flex flex-col gap-8 max-w-[1200px] mx-auto">
          ...
          <div className="flex gap-8 w-[100%] md:flex-col">
            <YouCan>
              ...
              <p className="text-sm font-semibold">
                Maintaining optimal inventory levels is a delicate balancing
                act. Excess inventory ties up capital, while inadequate stock
                leads to stockouts. Advanced inventory management systems and
                just-in-time (JIT) practices can help strike the right balance.
              </p>
            </YouCan>
            <YouCan>
