...
const Navbar = () => {
    ...
    const CustomLink: React.FC<CustomLinkProps> = ({ href, children }) => {
        ...
        return (
          <div className={`font-medium px-3 py-1 flex items-center justify-center text-sm relative group cursor-pointer border-2 border-solid rounded-2xl md:text-white hover:bg-primary hover:text-white hover:border-primary ${router.asPath === href ? 'bg-primary text-white' : ' text-black'}`} onClick={() => router.push(href)}>
            <a href={href}>
              {children}
            </a>
